...
export const AudioPlayer: React.FC = () => {
  ...
  <svg className="w-12 h-12" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M10.5 5.6v12.8A1.6 1.6 0 0 1 8.9 20H7.1a1.6 1.6 0 0 1-1.6-1.6V5.6A1.6 1.6 0 0 1 7.1 4h1.8a1.6 1.6 0 0 1 1.6 1.6zM16.9 4h-1.8a1.6 1.6 0 0 0-1.6 1.6v12.8a1.6 1.6 0 0 0 1.6 1.6h1.8a1.6 1.6 0 0 0 1.6-1.6V5.6A1.6 1.6 0 0 0 16.9 4z" fill="#FFFFFF"/>
  </svg>
) : (
  <svg className="w-12 h-12" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  >
    ...
    <svg className='w-12 h-12' viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
